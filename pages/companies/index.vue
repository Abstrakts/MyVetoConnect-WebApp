<template>
  <div class="companies">
    <div class="scoped-top100 body-top100">
      <div class="sidebar">
        <div class="heading">
          <h1 class="titre">Veterinaires de france</h1>
        </div>
...
export default {
  ...
  data: () => ({
    companies: [],
    mapToken:
      "pk.eyJ1IjoiYW5pbWFkcmF3IiwiYSI6ImNrOHN5c2xpbjBhMWczZmw5NjR2MmpiMWEifQ.wBMcBihIdo6yO0ksLr3wEg",
    mapOptions: {
      style: "mapbox://styles/mapbox/dark-v10",
      center: [2.3488, 46.8534],
      zoom: 5,
      minZoom: 5,
      maxZoom: 8,
